...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-0 flex-col items-center  bg-linear-to-r from-cyan-950  via-slate-950 to-slate-950  justify-center overflow-hidden  w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-60 overflow-visible w-20 bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
          <div className="absolute  w-full left- h-40 bottom-0 z-20 mask-[linear-gradient(to_top,white,transparent)]" />
