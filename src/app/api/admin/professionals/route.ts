  ...
  try {
    ...
    return NextResponse.json({
      ...
      professional: {
        ...
        professionalHeadline: result.professional.professionalHeadline,
        aboutMe: result.professional.aboutMe,
        profilePicture: result.professional.profilePicture,
        banner: result.professional.banner,
        location: result.professional.location,
        phone: result.professional.phone,
        email: result.professional.email,
        website: result.professional.website,
