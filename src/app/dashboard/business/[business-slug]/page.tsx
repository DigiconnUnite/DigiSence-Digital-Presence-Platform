...
import { getOptimizedImageUrl, generateSrcSet, handleImageError } from '@/lib/image-utils'
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
                                ...
                                try {
                                  ...
                                  const response = await fetch(
                                    "/api/business",
                                    {
                                      ...
                                      body: JSON.stringify({
                                        brandContent: cleanBrandContent,
                                      }),
                                    },
                                  );
                                  if (response.ok) {
                                    ...
                                    toast({
                                      title: "Success",
                                      description:
                                        "Brand content saved successfully!",
                                    });
                                  } else {
                                    toast({
                                      title: "Error",
                                      description:
                                        "Failed to save brand content",
                                      variant: "destructive",
                                    });
                                  }
                                } catch (error) {
          ...
          {(activeSection === "categories" && showRightPanel) ||
            (activeSection === "profile" && showRightPanel && (
              <div
                className={`${isMobile ? "fixed bottom-0 left-0 right-0 z-50 h-96" : "w-[480px]"} m-4 border rounded-3xl bg-white border-gray-200 flex flex-col shadow-sm transition-all duration-300 ease-in-out relative`}
              >
                      ...
                      {selectedProfileSection ? (
                        ...
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-600 mb-6">
                            Click on any section tab above or in preview to
                            start editing your profile.
                          </p>
                          <p className="text-sm text-gray-500">
                            Tip: You can also click directly on sections in full
                            page preview to edit them.
                          </p>
                        </div>
                      )}
                      ...
                      {selectedProfileSection === "hero" && (
                        <div className="space-y-6">
                          ...
                          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                            ...
                            <div className="flex items-center gap-2 mt-4 sm:mt-0">
                                ...
                                onClick={() => {
                                  if (selectedSlideIndex > 0) {
                                    ...
                                    newSlides[selectedSlideIndex] =
                                      newSlides[selectedSlideIndex - 1];
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() => {
                                  const newSlides = heroContent.slides.filter(
                                    (_, i) => i !== selectedSlideIndex,
                                  );
                                  setHeroContent((prev) => ({
                                    ...prev,
                                    slides: newSlides,
                          ...
                          {selectedSlideIndex !== null &&
                            heroContent.slides[selectedSlideIndex] && (
                              <div className="space-y-6">
                                {activeTab === "content" && (
                                  <Card className="rounded-3xl">
                                    <CardContent className="pt-6">
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              ...
                              <div>
                                ...
                                <div className="space-y-2">
                                  {businessInfoFormData.openingHours?.map(
                                    (hour: any, index: number) => (
                                      ...
                                      >
                                        <Input
                                          ...
                                          onChange={(e) => {
                                            const newHours = [
                                              ...businessInfoFormData.openingHours,
                                            ];
                                            newHours[index].day =
                                              e.target.value;
                                            setBusinessInfoFormData((prev) => ({
                                        ...
                                        <Button
                                          ...
                                          onClick={() => {
                                            const newHours =
                                              businessInfoFormData.openingHours.filter(
                                                (_, i) => i !== index,
                                              );
                                            setBusinessInfoFormData((prev) => ({
                                              ...prev,
                                ...
                                onClick={async () => {
                                  ...
                                  try {
                                    ...
                                    toast({
                                      title: "Error",
                                      description:
                                        "Failed to add portfolio image. Please try again.",
                                      variant: "destructive",
                                    });
                                  } finally {
                            ...
                            <CardContent>
                              {portfolioContent.images?.length > 0 ? (
                                                  ...
                                                  if (newAlt !== null) {
                                                    ...
                                                    try {
                                                      ...
                                                      toast({
                                                        title: "Error",
                                                        description:
                                                          "Failed to update portfolio image. Please try again.",
                                                        variant: "destructive",
                                                      });
                                                    }
                                                  }
                                              ...
                                              <Button
                                                ...
                                                onClick={() => {
                                                  setConfirmDialogData({
                                                    ...
                                                    action: async () => {
                                                      const updatedImages =
                                                        portfolioContent.images.filter(
                                                          (_, i) => i !== index,
                                                        );
                                                      ...
                                                      try {
                                                        ...
                                                        toast({
                                                          title: "Error",
                                                          description:
                                                            "Failed to delete portfolio image. Please try again.",
                                                          variant:
                                                            "destructive",
                                                        });
                                                      }
                                ...
                                <div className="text-center py-8">
                                  ...
                                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                                    No portfolio images to manage
                                  </h3>
                                  <p className="text-gray-600">
                                    Add portfolio images using the editor panel
                                  </p>
                                </div>
                              )}
                            </CardContent>
                      ...
                      onClick={async () => {
                        if (activeSection === "profile") {
                          if (selectedProfileSection === "info") {
                            ...
                            if (!business) return;
                            try {
                              const { newImageUrl, ...cleanPortfolioContent } =
                                portfolioContent;
                              const response = await fetch("/api/business", {
                                method: "PUT",
                                headers: { "Content-Type": "application/json" },
                                body: JSON.stringify({
                                  portfolioContent: cleanPortfolioContent,
                                }),
                              });
                              if (response.ok) {
                                const result = await response.json();
                              ...
                              <div className="max-h-48 overflow-y-auto">
                                ...
                                {(brandContent.brands || []).filter(
                                  (brand) =>
                                    ...
                                    brand.name
                                      .toLowerCase()
                                      .includes(brandFilterText.toLowerCase()),
                                ).length === 0 && (
