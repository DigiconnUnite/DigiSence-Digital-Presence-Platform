...
const testCredentials = [
  { email: 'admin@bdpp.com', password: 'admin123', role: 'SUPER_ADMIN' },
  { email: 'john@restaurant.com', password: 'business123', role: 'BUSINESS_ADMIN' }
]
...
async function checkServer() {
  try {
    ...
    return response.status !== 404 // 404 means server not running
  } catch (error) {
    return false
  }
}
