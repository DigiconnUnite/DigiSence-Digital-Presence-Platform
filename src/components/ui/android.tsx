...
export function Android({
  ...
  // These values must precisely match the visible phone screen area and its aspect ratio
  // See <rect> and <clipPath> below for matching
  const screenX = 9;
  const screenY = 14;
    ...
    >
      ...
      {src && (
        <image
          ...
          width={screenWidth}
          height={screenHeight}
          // Remove className utility for object-cover,
          // Let SVG scaling do the fit
